package com.example.apprunner.Organizer.menu6_profile_organizer.fragment;
...
import com.example.apprunner.Organizer.menu6_profile_organizer.Activity.EditProfileOrganizerActivity;
...
public class ProfileOrganizerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        fragmentHandle.findViewById(R.id.btn_edit_profile).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), EditProfileOrganizerActivity.class);
    ...
    private void profile(int id_user) { SecondFragment secondFragment = new SecondFragment();
