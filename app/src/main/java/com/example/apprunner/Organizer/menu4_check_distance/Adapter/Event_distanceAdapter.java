...
public class Event_distanceAdapter extends RecyclerView.Adapter<Event_distanceAdapter.Holder> {

    List<ResultQuery> event_organizer;
    Context context;

    public Event_distanceAdapter(Context context, List<ResultQuery> event_organizer) {
    ...
    @NonNull
    @Override
    public Event_distanceAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recycleview_event_distance_organizer,parent, false);
        return new Event_distanceAdapter.Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Event_distanceAdapter.Holder holder, int position) {
        ...
        holder.card_view_profile_organizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ChooseUserDistanceActivity.class);
