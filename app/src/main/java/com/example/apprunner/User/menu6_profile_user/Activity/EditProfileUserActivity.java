package com.example.apprunner.User.menu6_profile_user.Activity;
...
public class EditProfileUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rd_gender.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                Toast.makeText(EditProfileUserActivity.this, gender , Toast.LENGTH_LONG).show();
            }
        });
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               uploadImage();
               Intent intent = new Intent(EditProfileUserActivity.this, SecondActivity.class);
    ...
    private void uploadImage() {
        if(filePath == null){
            Toast.makeText(EditProfileUserActivity.this, "Empty image", Toast.LENGTH_SHORT).show();
        }
    ...
    private void edt_profile() {
        ...
        call.enqueue(new Callback<ResultQuery>() {
            ...
            public void onResponse(Call<ResultQuery> call, Response<ResultQuery> response) {
                Toast.makeText(EditProfileUserActivity.this,"แก้ไขข้อมูลสำเร็จ",Toast.LENGTH_LONG).show();
            }

            @Override
            public void onFailure(Call<ResultQuery> call, Throwable t) {
                Toast.makeText(EditProfileUserActivity.this,"แก้ไขข้อมูลไม่สำเร็จ",Toast.LENGTH_LONG).show();
            }
        });
    }
